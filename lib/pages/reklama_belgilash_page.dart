        ...
        Scaffold(
          appBar: AppBar(
            ...
            actions: [
              InkWell(
                onTap: () async {
                  await Navigator.push(context, CupertinoPageRoute(builder: (context) => NewReklamaPage(),));
                  getListAdvertising();
                },
                child: Padding(
  ...
  Widget itemOfAdvertising(Reklama reklama) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(color: Colors.grey.withOpacity(.3),blurRadius: 3,offset: Offset(0,2),)
        ]
      ),
      child: Row(
